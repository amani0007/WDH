    ...
    <section id="contact" class="contact">
      <div class="container">
        <div class="row">
          ...
          <center><h1 class="text-light"><a href="index.php"><span>Wakulima Digital Hub</span></a></h1></center>
...
<table width="755" border="0" class="table table-bordered">
  <tbody>
			...
			$tot=0;
			  ...
			  echo "
					...
					<td>&nbsp;<img src='imgsellingproduct/$rs1[product_img1]' width='75' height='50'></td>
					  ...
					  <td>Ksh. &nbsp;$Ksh $rs[cost]</td>
					  <td>&nbsp;$rs[quantity]&nbsp;$rs1[quantity_type]</td>
					  <td>Ksh. &nbsp;<span id='calccost$i'> $Ksh " . $rs['cost'] * $rs['quantity'] ."</span></td>					  
					</tr>";
					$i++;
    ...
    <tr>
      ...
      <th>Ksh.&nbsp; <?php echo $Ksh; ?> <?php echo  $tot; ?></th>
    </tr>
  </tbody>
</table>
<hr>
