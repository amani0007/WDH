...
<section id="hero" class="d-flex align-items-center">
    <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
      <h1>W.D.H - Change The Way You Trade...</h1>
      <h2>Wakulima Digital Hub is to help farmers by providing all kinds agriculture related information in the website...</h2>
...
<img src="img/pja1.jpg" style="width: 100%;">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left" data-aos-delay="200">
            ...
            <p class="font-italic"><b>Vision :</b> To provide a helping hand to the farmers and farm labourers in improving their lives through the medium of technology, thereby, improving the Agricultural Sector in the Kenyan Economy.
            </p>
            <ul>
              <li><i class="ri-check-double-line"></i> "W.D.H" is a model Agriculture/Farm management website application..</li>
              <li><i class="ri-check-double-line"></i> "W.D.H" provides a concept of virtual agricultural trade to its users.</li>
              <li><i class="ri-check-double-line"></i> "W.D.H" helps the wholesalers and retailers in buying produce from larger number of farmers.</li>
            </ul>
          </div>
        </div>
