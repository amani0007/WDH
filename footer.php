  ...
  <footer id="footer">
    ...
    <div class="footer-top">
      <div class="container">
        ...
        <div class="col-lg-3 col-md-6 footer-contact">
            <h3><strong>Wakulima Digital Hub</strong></h3>
            <p>
              T-mall,Nairobi-West <br>
              Nairobi, Kenya <br><br>
              <strong>Phone:</strong> <br>+254-12-345-6789 / +254-987-654-3210<br>
              <strong>Email:</strong><br>Operations@wakulimadigitalhub.com<br>Support@wakulimadigitalhub.com<br>
            </p>
          </div>
    ...
    <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
          &copy; Copyrights<strong><span> - wakulimadigitalhub</span></strong>
        </div>
      </div>
        <div class="credits">
        </div>
